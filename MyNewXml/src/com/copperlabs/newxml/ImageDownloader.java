...
public class ImageDownloader {
    ...
    public ImageDownloader(){
    	...
    	try {
    			...
    			extStorageDirectory = MyNewXmlApp.context.getExternalCacheDir().getAbsolutePath();
        ...
        try{
        	...
        	if (bitmap == null) {
        		...
        		if(hasExternalStoragePublicPicture(filename)){
        			...
        			Log.v("Image Download","The file is not existing in sdcard "+filename);
        			forceDownload(url, imageView);
        		}
        	} else {

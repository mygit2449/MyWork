...
public class YestarDayEmailsList 
{

	   private static final String LOG_TAG = YestarDayEmailsList.class.getSimpleName();
	
		EmailDataBaseHelper mEmailDataBase;
		SQLiteDatabase mDatabase;
		ArrayList<EmailModel> mYestarDay_emails = null;
		Context context;
		Calendar currentDate;
		
		public YestarDayEmailsList(Context context,  Calendar _currentDate) 
		{
			this.context = context;
			this.currentDate = _currentDate;
		}

		public ArrayList<EmailModel> get_YestarDay_Mails()
		{
					...
					mYestarDay_emails = new ArrayList<EmailModel>();
		 	        ...
		 	        try {
		 	        	 ...
		 	        	 if (cursor.moveToFirst()) 
				         {
				  			 	...
				  			 	{              
					                    	   ...
					                    	   mYestarDay_emails.add(mCurrentEmail);

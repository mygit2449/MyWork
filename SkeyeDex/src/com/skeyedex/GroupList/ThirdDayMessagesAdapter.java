...
public class ThirdDayMessagesAdapter extends BaseAdapter
{
		...
		public ThirdDayMessagesAdapter(Context context, ArrayList _allMessages, HashMap<String, Object> checkEmailMap, HashMap<String, Object> checkSmsMap)
		{
		...
		public View getView(final int position, View convertView, ViewGroup parent) 
		{
				...
				if (type == TYPE_ITEM)
				{
					...
					email_relative.setBackgroundResource(R.drawable.gl_brown_bar);

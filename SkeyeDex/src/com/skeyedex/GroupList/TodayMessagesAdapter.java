...
public class TodayMessagesAdapter extends BaseAdapter
{
	...
	public TodayMessagesAdapter(Context context, ArrayList _allMessages, HashMap<String, Object> checkEmailMap, HashMap<String, Object> checkSmsMap)
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
			...
			Log.v(LOG_TAG, "position"+arrMessages.get(position));
			if (convertView == null)
			{
			...
			if (type == TYPE_ITEM)
			{
				...
				email_relative.setBackgroundResource(R.drawable.gl_red_bar);
				...
				email_check.setTag(position);
					...
					if(obj instanceof EmailModel)
					{
					...
					}else 
						{
							 ...
							 alltime = getMessageTime(smsModel.getDate());

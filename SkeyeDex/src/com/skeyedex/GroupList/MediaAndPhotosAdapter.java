...
public class MediaAndPhotosAdapter extends BaseAdapter{

	

	private static final String LOG_TAG = MediaAndPhotosAdapter.class.getSimpleName();
	...
	public MediaAndPhotosAdapter(Context context, ArrayList _allMessages, HashMap<String, Object> checkEmailMap, HashMap<String, Object> checkSmsMap)
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
			...
			if (convertView == null)
			{
				...
				convertView = inflater.inflate(R.layout.category_listview, null);
					...
					email_relative.setBackgroundResource(R.drawable.gl_green_bar);

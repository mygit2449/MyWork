...
public class BusinessAndDocumentsAdapter extends BaseAdapter{


	private static final String LOG_TAG = BusinessAndDocumentsAdapter.class.getSimpleName();
	...
	Object obj;
	Context context;
	ArrayList arrBusinesssMessages;
	ArrayList<Object> newEmail = new ArrayList<Object>();
	
	public BusinessAndDocumentsAdapter(Context context, ArrayList _allMessages, HashMap<String, Object> checkEmailMap, HashMap<String, Object> checkSmsMap)
	{
		
		this.context=context;
		this.arrBusinesssMessages = _allMessages;
	...
	public int getCount() {
		...
		return arrBusinesssMessages.size();
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
			...
			obj= arrBusinesssMessages.get(position);
			...
			if (convertView == null)
			{
				...
				email_relative.setBackgroundResource(R.drawable.gl_blue_bar);
				...
				if(obj instanceof EmailModel)
				{
					 ...
					 EmailModel emailModel = (EmailModel)arrBusinesssMessages.get(position);
					 ...
					 icon_image.setImageResource(((EmailModel) arrBusinesssMessages.get(position)).getImage_resourceId());
					 SimpleDateFormat  formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
								 
					 //email check box selection
					 if (((EmailModel) arrBusinesssMessages.get(position)).isSelected())
						{
				...
				}else 
				 {
					 ...
					 SMSmodel smsModel = (SMSmodel) arrBusinesssMessages.get(position);
					...
					if (((SMSmodel) arrBusinesssMessages.get(position)).isSelected())
					{
					...
					public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) 
					{
						...
						if(selectType == "manual")
						{
							if (obj instanceof EmailModel) 
							{
								...
								((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).setSelected(isChecked);
								Log.e("", "Email "+((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id());
								
								ArrayList<Object> email = (ArrayList<Object>) mSelectedEmail.get(((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id());
								...
								{										
									...
									if(email == null )
									{
											...
											newEmail.add(arrBusinesssMessages.get((Integer) buttonView.getTag()));
										
										    mSelectedEmail.put(((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id() , newEmail);
										
									}else{
												
										Log.e("LogCat", "email  not null"+((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id());
										
										email.add(arrBusinesssMessages.get((Integer) buttonView.getTag()));
										
										mSelectedEmail.put(((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id() , email);								
								...
								}else 
								{
										...
										emails =(ArrayList<EmailModel>) mSelectedEmail.put(((EmailModel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getEmail_id() , email);
										...
										email.remove(arrBusinesssMessages.get((Integer) buttonView.getTag()));
							...
							}else //sms checking
							  {
								...
								((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).setSelected(isChecked);
								Log.e("", "Sms "+((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender());
								
								ArrayList<Object> sms = (ArrayList<Object>) mSelectedSms.get(((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender());  // saving sms based on sender
								...
								{										
									...
									if(sms == null )
									{
										...
										newSms.add(arrBusinesssMessages.get((Integer) buttonView.getTag()));
										mSelectedSms.put(((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender() , newSms);
										
									}else
									{
												
										Log.e("LogCat", "sms  not null"+((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender());
										sms.add(arrBusinesssMessages.get((Integer) buttonView.getTag()));
										mSelectedSms.put(((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender(), sms);								
									}
								...
								}else
								 {
										...
										smsArr =(ArrayList<SMSmodel>) mSelectedSms.put(((SMSmodel) arrBusinesssMessages.get((Integer) buttonView.getTag())).getSender() , sms);
										...
										sms.remove(arrBusinesssMessages.get((Integer) buttonView.getTag()));

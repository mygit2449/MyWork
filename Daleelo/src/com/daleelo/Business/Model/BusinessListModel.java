...
public class BusinessListModel implements Serializable{
	...
	private String RevierwsCount = "0";
	...
	public void setBusinessIsfeatured(String businessIsfeatured) {
		BusinessIsfeatured = businessIsfeatured;
	}
	...
	public String getRevierwsCount() {
		return RevierwsCount;
	}
	public void setRevierwsCount(String revierwsCount) {
		RevierwsCount = revierwsCount;
	}

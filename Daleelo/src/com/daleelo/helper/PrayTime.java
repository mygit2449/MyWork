...
//        this.setCalcMethod(0);
 ...
 private double[] tuneTimes(double[] times) {
    ...
    //model class variables declaration
	...
	public double[] getPrayerTimesCurrent() {
		return prayerTimesCurrent;
	}

	public void setPrayerTimesCurrent(double[] prayerTimesCurrent) {
		this.prayerTimesCurrent = prayerTimesCurrent;
	}
}

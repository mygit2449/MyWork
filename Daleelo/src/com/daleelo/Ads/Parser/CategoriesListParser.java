...
public class CategoriesListParser extends BaseHttpLoader{
	...
	public CategoriesListParser(String feedUrl, Handler handler) {
		super(feedUrl);
			...
			while (eventType != XmlPullParser.END_DOCUMENT && !done) {
				...
				case XmlPullParser.END_TAG:
					...
					if (name.equalsIgnoreCase("ArrayOfCategory") && requiredTagFound) {
						...
						messageToParent.what = FOUND_CATEGORIES;
						messageData.putSerializable("categoriesfeed", mCategoryFeeds);

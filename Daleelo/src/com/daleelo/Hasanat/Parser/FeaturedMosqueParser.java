...
public class FeaturedMosqueParser extends BaseHttpLoader {
	...
	public FeaturedMosqueParser(String feedUrl, Handler handler) {
		super(feedUrl);
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT && !done) {
				...
				case XmlPullParser.END_TAG:
					...
					if (name.equalsIgnoreCase("BusinessDetail") && mBusinessDetailModel != null) {

						mBusinessList.add(mBusinessDetailModel);
						...
						messageData.putSerializable("datafeeds", mBusinessList);

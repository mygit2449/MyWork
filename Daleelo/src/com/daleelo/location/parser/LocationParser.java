package com.daleelo.location.parser;
...
import com.daleelo.location.model.AddressComponentModel;
import com.daleelo.location.model.LocationModel;
import com.daleelo.location.model.LocationResultModel;
	                        ...
	                        if (name.equalsIgnoreCase(GEOCODE_RESPONSE))
	                        {
	                        	...
	                        	if (name.equalsIgnoreCase(STATUS)){	 
	                            	...
	                            	if(name.equalsIgnoreCase(FORMATTED_ADDRESS)){
	                            		...
	                            		}if(name.equalsIgnoreCase(SHORT_NAME)){
	                            			mAddressComponentModel.setShortName(parser.nextText());
